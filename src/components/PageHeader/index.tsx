  ...
  return (
    <StyledPageHeader>
      <Flex alignItems="center">
        <IconButton variant="text" onClick={onPresentSettings} title="Settings" className="lgraycolor">
          <CogIcon />
        </IconButton>
        <Details style={{textAlign:"center"}}>
          <Heading mb="8px">{title}</Heading>
          {description && (
            <Text color="lgray" fontSize="14px">
              {description}
            </Text>
          )}
        </Details>
        
        <IconButton variant="text" onClick={onPresentRecentTransactions} title="Recent transactions" className="lgraycolor">
          <HistoryIcon />
        </IconButton>
      </Flex>
